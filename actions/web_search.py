...
def _compare(items: list[str], aspect: str) -> str:
    ...
    try:
        ...
        print(f"[WebSearch] [Warning] Gemini compare failed: {e} - falling back to DDG")
...
def web_search(
    ...
    # Cancellation checkpoint before network I/O
    ...
    try:
        ...
        print("[WebSearch] [OK] OpenRouter OK.")
        return result
    except Exception as e:
        print(f"[WebSearch] [Warning] OpenRouter failed ({e}) - trying DDG...")

    # Cancellation checkpoint before fallback network I/O
    if cancellation_manager.is_cancelled():
        return "Search cancelled by user."
