...
_MONTH_MAP: dict[str, int] = {
    ...
    "ocak": 1,  "?ubat": 2,  "mart": 3,   "nisan": 4,
    "may?s": 5, "haziran": 6, "temmuz": 7, "a?ustos": 8,
    "eylül": 9, "ekim": 10,  "kas?m": 11, "aral?k": 12,
}
...
# replace the try/except genai block with:
    try:
        ...
        print(f"[FlightFinder] [WARN] date parse failed: {e}")
