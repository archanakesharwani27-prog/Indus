...
from ui.avatar.avatar_state import Emotion, MouthState
...
class AssetResolver:
    ...
    def get_face_pixmap(self, emotion: Emotion, blinking: bool = False, gaze: str = "center") -> Optional[QPixmap]:
        """
        Resolves the appropriate base face image according to active emotion, blink, and gaze.
        Structure:
          assets/avatar/<emotion>/face_<emotion>.png
          assets/avatar/<emotion>/blink_<emotion>.png
          assets/avatar/<emotion>/gaze_<direction>.png
        """
        ...
        # Fallback to root face.png
        return self._fallback_pixmap

    def get_mouth_pixmap(self, mouth: MouthState) -> Optional[QPixmap]:
        """
        Resolves transparent mouth overlay pixmap.
        Structure:
          assets/avatar/mouth/mouth_blank.png
          assets/avatar/mouth/mouth_slight.png
          assets/avatar/mouth/mouth_medium.png
          assets/avatar/mouth/mouth_wide.png
        """
