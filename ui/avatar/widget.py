...
from ui.avatar.avatar_state import AvatarState
from ui.avatar.emotion_manager import IndusEmotionFaceManager


class AvatarWidget(QWidget):
    """
    Dedicated 2-layer PyQt6 Presentation Widget for the INDUS Avatar.
    Base Face layer + Mouth overlay layer with WA_TransparentForMouseEvents.
    """
    ...
    def _sync_geometry(self):
        """Sync layer geometries responsive to window dimensions."""
        self.base.setGeometry(self.rect())

        # Proportional mouth region
